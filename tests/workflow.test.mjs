...
test("配信対象は明示列挙で、練習用素材を含む", async () => {
  ...
  for (const asset of [
    "assets/favicon.svg",
    // 練習用素材が抜けると、添付・貼り付けが要る回がリンク切れになる
    "assets/sample-kodomo-kibou.md",
    "assets/sample-gakkyukai-kiroku.md",
    "assets/sample-gyoji-junbi.md",
    "assets/sample-furikaeri-kanso.md",
    "assets/sample-hanseikai-iken.md",
  ]) {
